...
class SerialDeployWorkflow extends BasicDeployWorkflow {
  deployJobId;
  ...
  constructor(project, options) {
    ...
    this.workflow.addJob("deploy-serialDemo", {
      runsOn: [DEFAULT_UBUNTU],
    ...
    this.workflow.addJob("deploy-serialProd", {
      runsOn: [DEFAULT_UBUNTU],
      needs: [this.buildJobId, "deploy-serialDemo"],
